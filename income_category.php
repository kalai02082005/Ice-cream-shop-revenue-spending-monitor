...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["category_name"])) {
    ...
    if (!empty($category_name)) {
        ...
        if ($stmt->execute()) {
            echo "<script>alert('Category added successfully!'); window.location.href = 'income_category.php';</script>";
        } else {
...
if ($search) {
    $stmt = $conn->prepare("SELECT * FROM income_categories_new WHERE category_name LIKE ? ORDER BY category_name ASC");
    $likeSearch = "%" . $search . "%";
    ...
    $categories = $conn->query("SELECT * FROM income_categories_new ORDER BY category_name ASC");
}
?>
